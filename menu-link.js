$(function () {
    ...
    //获取三个联动菜单
    var mlink1 = $(".menu-link1");
    var mlink2 = $(".menu-link2");
    var mlink3 = $(".menu-link3");
    ...
    function menuChange(menuLink1,menuLink2,menuLink3 ) {
        ...
        index1 = menuOneArrs.indexOf(menuLink1.val());
        menuTwoArrs = menuArrs.menuTwo[index1].menuTwoArrs;

        //一菜单监听
        menuLink1.on("change", function () {
            index1 = menuOneArrs.indexOf(menuLink1.val());
            menuTwoArrs = menuArrs.menuTwo[index1].menuTwoArrs;
            menuLink2.html("");//菜单二清空
            renderMenuArr(menuTwoArrs, menuLink2);//渲染菜单二的数据
            index2 = menuTwoArrs.indexOf(menuLink2.val());
